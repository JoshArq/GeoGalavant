    ...
    const handleReserveCar = () => {
        ...
        .then((data) => {
            if (data.conf) {
                ...
                document.getElementById("confNum").innerText = data.conf;
        ...
        switch (step) {
            case 0: 
                ...
                if(reservation.pickup.checkValidity() && testPickup > (new Date())) {
                    form.pickupDateTime = reservation.pickup.value;
                }
                else {
                ...
                if(reservation.dropoff.checkValidity() 
                    ...
                    form.dropoffDateTime = reservation.dropoff.value;
                }
                else {
        ...
        <Container as={'main'} className="py-5">
            <Form noValidate id="reservation">
                ...
                <section className="d-none" id="done">
                    ...
                    <p>Your reservation number is <span id="confNum">###</span>. Use this code to unlock your Gyrocar.</p>
